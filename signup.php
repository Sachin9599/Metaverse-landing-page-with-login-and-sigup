                ...
                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                  ...
                  <form class="mx-1 mx-md-4" action="/loginsystem/signup.php" method="post">
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fa fa-user icon fa-lg me-3 fa-fw"></i>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fa fa-lock fa-lg me-3 icon fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      <i class="fa fa-key fa-lg me-3 icon fa-fw"></i>
                      <div class="form-outline flex-fill mb-0">
                        ...
                        <small>Make sure your password is correct</small>
                      </div>
                    </div>
